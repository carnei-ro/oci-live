...
inputs = {
  ...
  metadata = {
    ...
    user_data           = dependency.talos_config.outputs.controlplane_yaml_b64
  }
  ...
  create_vnic_details = {
    ...
    private_ip       = cidrhost(dependency.vcn.outputs.subnet_all_attributes.public.cidr_block, 100)
    nsg_ids = [
