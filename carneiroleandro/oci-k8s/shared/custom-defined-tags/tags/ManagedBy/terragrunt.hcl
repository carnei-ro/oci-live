...
dependency "tag_namespace" {
  config_path = "../../namespace/Custom-Tags"
}

inputs = {
  tag_namespace_id = dependency.tag_namespace.outputs.id

  name        = "ManagedBy"
  description = "Generic tag to inform who is managing the resource"
}
