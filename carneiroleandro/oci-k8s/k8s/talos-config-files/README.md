# Terraform Module for talos-config-files
...
| <a name="input_k8s_version"></a> [k8s\_version](#input\_k8s\_version) | The version of Kubernetes to install | `string` | `"1.27.2"` | no |
